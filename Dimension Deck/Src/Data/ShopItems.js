...
const FALLBACK_CARDS = [
    // Active — Melee
    { card_name: 'Iron Fist',        card_type: 'active',    subtype: 'melee',   rarity: 'rare',      base_damage:  55, base_heal:  0, cooldown_seconds:  5, shop_cost:  50, description: 'A powerful close-range blow dealing 55 damage within 28px.',          effect_json: { range:  28, spread: 1.099 } },
    { card_name: 'Nova Burst',       card_type: 'active',    subtype: 'melee',   rarity: 'epic',      base_damage: 110, base_heal:  0, cooldown_seconds:  9, shop_cost:  80, description: 'Unleash an explosion dealing 110 damage to all enemies within 72px.', effect_json: { range:  72, spread: 3.142 } },
    { card_name: 'Shadow Blade',     card_type: 'active',    subtype: 'melee',   rarity: 'legendary', base_damage: 180, base_heal:  0, cooldown_seconds: 15, shop_cost: 130, description: 'A devastating strike dealing 180 damage to enemies within 48px.',     effect_json: { range:  48, spread: 2.356 } },
    // Active — Heal
    ...
    { card_name: 'Rebound',          card_type: 'automatic', subtype: 'melee',   rarity: 'rare',      base_damage:  15, base_heal:  0, cooldown_seconds:  0, shop_cost:  65, description: 'When hit, deal 15 damage to enemies within 48px.',                    effect_json: { trigger: 'on_hit_received', range:  48 } },
    { card_name: 'Berserker Rush',   card_type: 'automatic', subtype: 'melee',   rarity: 'rare',      base_damage:  20, base_heal:  0, cooldown_seconds:  0, shop_cost:  70, description: 'Dashing deals 20 damage to enemies within 32px.',                     effect_json: { trigger: 'on_dash', range:  32 } },
    ...
    { card_name: 'Chain Kill',       card_type: 'automatic', subtype: 'melee',   rarity: 'epic',      base_damage:  25, base_heal:  0, cooldown_seconds:  0, shop_cost: 100, description: 'Killing an enemy deals 25 damage to all others within 64px.',         effect_json: { trigger: 'on_kill', from_enemy: true, range:  64 } },
];
