...
// frameWidth=32, frameHeight=32 → row 0 (right) srcY=0, row 1 (left) srcY=32
const SHEETS = {
  right: {
    idle:  new SpriteSheet({ image: _img, frameWidth: 32, frameHeight: 32, frameCount: 1, row: 0, startCol: 0 }),
    chase: new SpriteSheet({ image: _img, frameWidth: 32, frameHeight: 32, frameCount: 1, row: 0, startCol: 1 }),
    shoot: new SpriteSheet({ image: _img, frameWidth: 32, frameHeight: 32, frameCount: 3, row: 0, startCol: 2 }),
  },
  left: {
    idle:  new SpriteSheet({ image: _img, frameWidth: 32, frameHeight: 32, frameCount: 1, row: 1, startCol: 0 }),
    chase: new SpriteSheet({ image: _img, frameWidth: 32, frameHeight: 32, frameCount: 1, row: 1, startCol: 1 }),
    shoot: new SpriteSheet({ image: _img, frameWidth: 32, frameHeight: 32, frameCount: 3, row: 1, startCol: 2 }),
  },
};
...
export default class Spirit extends Enemy {
  constructor(position, deps) {
    ...
    this._animation = new Animation({ sheet: SHEETS.right.idle, fps: FPS_IDLE, loop: true });
  }
